  ...
  return (
    <div>
      <Container className="space-y-4">
        ...
        <h2 className="text-3xl font-bold">{m.privacy_1()}</h2>
        <h3 className="text-2xl font-bold">{m.privacy_2()}</h3>
        <p>{m.privacy_3()}</p>
        ...
        <h4 className="text-xl font-bold">Wie erfassen wir Ihre Daten?</h4>
        <p>
        ...
        <h4 className="text-xl font-bold">Wofür nutzen wir Ihre Daten?</h4>
        <p>
        ...
        <h2 className="text-3xl font-bold">2. Hosting</h2>
        <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
        <h3 className="text-2xl font-bold">Externes Hosting</h3>
        <p>
        ...
        <h3 className="text-2xl font-bold">Datenschutz</h3>
        <p>
        ...
        <p>
          Telefon: +06-1091 3357
          <br />
          E-Mail: P.m.lansink@saxion.nl
        </p>
        <p>
        ...
        <h3 className="text-2xl font-bold">Recht auf Datenübertragbarkeit</h3>
        <p>
        ...
        <h3 className="text-2xl font-bold">SSL- bzw. TLS-Verschlüsselung</h3>
        <p>
        ...
        <h2 className="text-3xl font-bold">5. Newsletter</h2>
        <h3 className="text-2xl font-bold">Newsletterdaten</h3>
        <p>
