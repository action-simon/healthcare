...
export const Footer = () => {
  return (
    <footer className="w-full self-end bg-accent/80 py-14">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="">
          <Link
            href="/"
            className="flex items-center justify-center text-2xl font-bold transition-all duration-500
              hover:text-primary"
          >
          ...
          <ul
            className="mb-10 flex flex-col items-center justify-center gap-7 py-16 text-lg
              transition-all duration-500 md:flex-row md:gap-12"
          >
            <li>
              <Link
                href="/#keyInformation"
          ...
          <hr className="mx-auto w-11/12 border-foreground/15 py-8" />

          <div className="mb-14 flex items-center justify-center space-x-10">
            <Link
              href="https://www.instagram.com/zeinabalhaybi"
              target="_blank"
              className="block text-foreground transition-all duration-500 hover:text-primary "
            >
              <svg
          ...
          <span className="block text-center text-lg">
            © 2024{" "}
            <Link
              className="text-primary transition-all duration-500 hover:text-primary/70"
              href="/"
            >
              {m.home_metadata_title()}
            </Link>
