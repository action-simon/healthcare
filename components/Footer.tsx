  ...
  return (
    <footer className="w-full bg-accent/80">
      <Container>
        <Link
          href="/"
          className="mb-12 flex items-center justify-center text-2xl font-bold transition-all
        ...
        <ul
          className="mb-12 flex flex-col items-center justify-center gap-4 text-lg transition-all
            duration-500 md:flex-row md:gap-12"
        >
          <li>
            <Link
              href="/#keyInformation"
        ...
        <hr className="mx-auto mb-6 w-11/12 border-foreground/15" />

        <div className="mb-12 flex items-center justify-center space-x-6 ">
          <Link
            href="https://www.instagram.com/zeinabalhaybi"
            target="_blank"
            className="block p-4 text-foreground transition-all duration-500 hover:text-primary "
          >
            <svg
